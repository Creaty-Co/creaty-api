...
from app.users.verification.email_senders.mentor_first_name import UserEmailSender
...
register_verifier: Final[EmailVerifier] = EmailVerifier(
    email_sender=SimpleEmailSender(template_name='email/after-sign-up.html'),
...
password_reset_verifier: Final[EmailVerifier] = EmailVerifier(
    email_sender=SimpleEmailSender(template_name='email/password-reset.html'),
